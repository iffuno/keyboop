...
final class AppBanner {
    ...
    @objc private func closeTapped() {
        ...
        // Крестик — отдельный пользовательский ответ, а не программная замена баннера. Для ещё не
        // скачанного обновления это «пропустить версию»; для опционального мгновенного режима файл
        // уже принадлежит Sparkle и крестик лишь откладывает его до выхода, как сказано в настройке.
        // Кто показал плашку, тот и решает, какой из этих ответов сейчас возможен.
