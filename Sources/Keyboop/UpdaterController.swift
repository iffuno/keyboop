...
///
/// Поведение (security review 15.06 + выбор Ивана): проверка и фоновое скачивание ВКЛ по умолчанию,
...
final class UpdaterController: NSObject, SPUUpdaterDelegate {
    ...
    /// Проверить вручную («Проверить сейчас» в настройках) — тут Sparkle покажет своё окно (юзер сам попросил).
